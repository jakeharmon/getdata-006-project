...
<i>All data was derived from the Human Activity Recognition Using Smartphones Dataset</i>

Below is the readme.txt for the superset of data. The subset of data that was created for this project is described further in the codebook.txt.
